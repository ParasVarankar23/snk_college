    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                {/* Back Button */}
                <Link href="/academics" className="inline-flex items-center text-indigo-600 hover:text-indigo-800 mb-8 group transition-colors duration-200">
                ...
                {/* Header Section */}
                <div className="bg-gradient-to-r from-indigo-500 to-blue-500 rounded-2xl shadow-2xl p-8 md:p-12 mb-12 text-white">
                    <div className="flex items-center mb-4">
                        <span className="text-6xl mr-6">🧪</span>
                        <div>
                            <h1 className="text-4xl md:text-5xl font-bold mb-2">12th Science</h1>
                            <p className="text-indigo-100 text-lg">Advanced Year - Science Stream</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="px-8 py-6 bg-gradient-to-r from-indigo-500 to-blue-500">
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {subjects.map((subject, index) => (
                                    <tr key={subject.name} className="hover:bg-indigo-50 transition-colors duration-200">
                    ...
                    <div className="md:hidden divide-y divide-gray-200">
                        {subjects.map((subject, index) => (
                            <div key={subject.name} className="p-6 hover:bg-indigo-50 transition-colors duration-200">
