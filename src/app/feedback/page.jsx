        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
                <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-500 mb-6">Thank you for sharing your experience with S. Patil Junior College.</p>
                    <button
                        onClick={() => {
                            setSubmitted(false);
            ...
            <div className="max-w-xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 mt-2">
                        Let us know about your experience at S. Patil Junior College
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-md p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Share your experience at S. Patil Junior College..."
                            rows={4}
