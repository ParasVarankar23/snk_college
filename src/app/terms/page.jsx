...
export const metadata = {
    title: "Terms of Use | S. Patil Junior College",
    description: "Terms and Conditions for using the S. Patil Junior College website and services.",
};
        ...
        content: [
            {
                ...
                text: "By accessing or using the website of S. Patil Junior College ('the College', 'we', 'us', or 'our'), you agree to be legally bound by these Terms of Use. If you do not agree with any part of these terms, please discontinue use of the website immediately.",
            },
            {
    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                text: "You may not copy, reproduce, distribute, modify, or create derivative works from any content on this website without prior written permission from the College. All logos, photographs, text, graphics, and other materials on this site are the intellectual property of S. Patil Junior College or their respective owners.",
            },
        ],
    },
    {
        ...
        content: [
            {
                ...
                text: "All content published on this website, including but not limited to text, images, logos, video, audio, data, and software, is the property of S. Patil Junior College or its content suppliers and is protected under applicable Indian intellectual property laws.",
            },
            {
            ...
            <section className="relative bg-gradient-to-br from-[#7a1c1c] via-[#6b1a1a] to-[#4a1010] text-white overflow-hidden">
                ...
                <div className="relative max-w-5xl mx-auto px-6 py-20 text-center">
                    ...
                    <p className="text-red-200/80 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                        Please read these Terms of Use carefully before using the S. Patil Junior College
            ...
            <section className="max-w-5xl mx-auto px-6 py-14">
                ...
                <div className="flex items-start gap-4 bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-10">
                    ...
                    <p className="text-sm text-amber-800 leading-relaxed">
                        ...
                        between you and S. Patil Junior College. By continuing to use this website,
